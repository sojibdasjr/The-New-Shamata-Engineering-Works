        ...
        <div className=" py-5 text-black flex justify-between mx-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-semibold md:font-bold md:text-2xl md:tracking-widest">
              The New Shamata <br />{" "}
              <span className="text-purple-500">Engineering Works</span>
            </h1>
          </div>
          {/* contact Info */}
          <div className="flex justify-center gap-4 items-center">
            <div className="hidden md:flex items-center gap-2">
              <MdLocalPhone className=" text-4xl text-purple-500 border border-slate-300 rounded-full p-1 " />
              <div>
            ...
            <div className="hidden md:flex  items-center gap-2">
              <SiMinutemailer className=" text-4xl text-purple-500 border border-slate-300 rounded-full p-1 " />
              <div>
